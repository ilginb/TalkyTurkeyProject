//
//  CommonQuizViewController.swift
//  TalkyTurkey_V1
//
...
class CommonQuizViewController: UIViewController {
    var currentQuestion : Int?
    var correctAnswer : CommonPhraseAnswer? = nil
    var shuffledAnswers : Array<CommonPhraseAnswer> = []
    ...
    override func viewDidLoad() {
        ...
        questionDictionary = CommonPhraseQuestion.getCommonPhraseQuestions()
        var answerDictionary = CommonPhraseAnswer.getCommonPhraseAnswers()
